...
public class LessonRepositoryImpl implements LessonRepository {
    ...
    @Override
    public void markAttended(@NonNull String lessonId, @NonNull String studentId, @NonNull Consumer<Status<LessonEntity>> callback) {
        lessonApi.markAttended(lessonId, studentId).enqueue(new CallToConsumer<>(
                callback,
                lessonDto -> {
                    if (lessonDto != null) {
                        final String _id = lessonDto.id;
